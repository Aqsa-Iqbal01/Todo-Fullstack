...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // Forward the request to the backend's todos endpoint (without trailing slash)
...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // Forward the request to the backend's todos toggle endpoint (without trailing slash)
    // Handle redirects manually to preserve auth headers
